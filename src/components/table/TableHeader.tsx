...
import { CloseOutlined, Filter } from '@mui/icons-material';
...
export default function TableHeader(props: any) {
  ...
  const customValueRenderer = (selected, _filter) => {
  ...
  return (
    <TableHead>
      <TableRow>
        {columns.map((headCell: any, headerIndex: any) => (
          <>
            {headCell.is_show && (
              <TableCell
                key={headCell.id}
                      ...
                      {headCell.filters.map((filter: any, index: any) => {
                        if (filter.type === 'select') {
                          ...
                          return (
                            ...
                            <Box key={index}>
                              <MultiSelect
                                ...
                                // onChange={(event) =>
                                //   onSelectChange(event, headerIndex, index, filter)
                                // }
                                onChange={setSelected}
                                labelledBy={'Select'}
                                className="multiselect-chip multi-selection"
                                valueRenderer={(event) =>
                                  customValueRenderer(event, filter)
                                }
                                // value={filter.value}
                                value={selected}
                          ...
                          return (
                            <FormControl
                              key={index}
                              className="calender-sec theadCalender"
                            >
