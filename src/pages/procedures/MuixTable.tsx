...
import {
  Autocomplete, FormControl, Pagination, InputAdornment, Select,
  TextField, MenuItem
} from '@mui/material';
...
function EnhancedTableHead(props: any) {
  const { onSelectAllClick, order, orderBy, numSelected, rowCount, onRequestSort, columns, setColumns }:any =
    props;
