...
const validationSchema = Yup.object().shape({
  ...
  name: Yup.string().trim().required("Procedure name is required").max(50, 'Must be 50 characters or less').matches(/^[a-zA-Z0-9_]+( [a-zA-Z0-9_]+)*$/, 'Label cannot have empty spaces'),
});
