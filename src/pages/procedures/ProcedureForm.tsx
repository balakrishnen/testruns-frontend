...
const validationSchema = Yup.object().shape({
  ...
  name: Yup.string().trim().required("Procedure name is required").max(20, 'Must be 20 characters or less').matches(/^[a-zA-Z0-9_]+( [a-zA-Z0-9_]+)*$/, 'Label cannot have empty spaces'),
});
