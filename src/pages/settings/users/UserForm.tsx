        ...
        if (row?._id) {
          ...
          dispatch(fetchSingleUserData(temp)).then((isSucess) => {
            if (isSucess.get_user) {
              ...
              formik.setFieldValue('departmentId', isSucess.get_user?.departmentId?.map((item: any) => (departmentData?.find(obj => {console.log("obj",obj); (obj.id == item)}))) || []);
...
// dispatch(fetchinstitutionData(payload))
            ...
            <Grid container spacing={2} className="asset-popup">
              ...
              >
                <Box style={{ position: 'relative' }}>
                  ...
                  >
                    {organizationData?.length!==0?organizationData?.map((item: any, index) => (
              ...
              >
                <Box style={{ position: 'relative' }}>
                  ...
                  <Autocomplete
                    ...
                    getOptionLabel={(option: any) => {console.log(option?.label); return(option?.label)}}
