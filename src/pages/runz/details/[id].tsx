        ...
        <PrivateRoute>
            ...
            <Box className="runzdetails-page">
                    ...
                    <Box sx={{ padding: "24px 0px", margin: "0px 24px" }}>
                        <Grid container spacing={2}>
                            <Grid item xs={12} sm={10} md={10} lg={5} xl={6}>
                                <Box>
                                    <Typography className="id-detail">ID023659ADN&ensp;/&ensp;Dept-Computer science&ensp;/&ensp;Lab-Data structure</Typography>
                                    <Typography className="id-detail-title">The simple pendulum</Typography>
                                </Box>
                            </Grid>
                            <Grid item xs={12} sm={2} md={2} lg={7} xl={6}>
                                <Box sx={{ display: { xs: 'none', lg: 'flex' }, alignItems: "center", height: "100%", justifyContent: "end" }}>
                                    <Button type="submit" variant="contained" className="edit-btn">
                                        <img src={shareimgarrow} alt='edit' style={{ marginRight: '8px' }} />
                                        Assign
                                    </Button>
                                    <Button type="submit" variant="contained" className="edit-btn">
                                        <img src={shareimg} alt='edit' style={{ marginRight: '8px' }} />
                                        Share
                                    </Button>
                                    <Button type="submit" variant="contained" className="edit-btn" onClick={() => { setDialog2Open(true); }}>
                                ...
                                <Box sx={{ display: { xs: 'block', lg: 'none' }, textAlign: 'right' }}>
                                    <IconButton
                                        aria-label="more"
                                        id="long-button"
                ...
                <Box className="main-runzdetails runz-height">
                 ...
                 <SplitPane >
                        <Grid item xs={12} sm={12} md={12} lg={7} xl={7} sx={{ padding: '0px !important' }}>
                            <Box sx={{ padding: "24px 0px", margin: "0px 24px" }}>
                                <Box className="runz-height leftside-runz" sx={{ overflowY: 'auto' }}>
                                    Aim
                        ...
                        <Grid item xs={12} sm={12} md={12} lg={5} xl={5} className="rightside-runz" sx={{ borderLeft: { xs: '0px', lg: '2px solid #9F9F9F;' } }}>
                            <Box className="runz-height" sx={{ width: '100%' }}>
                                <Box sx={{ borderBottom: 0 }}>
                                    <Tabs value={value} onChange={handleChange} aria-label="tabs-common" className='tabs-common'>
