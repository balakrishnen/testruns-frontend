...
export const StatusList = [
  ...
  { id: 2, name: 'In-Active', state: true },
];

export const AvailabilityList = [
  { id: 1, name: 'Available', state: true },
  { id: 2, name: 'Not available', state: true },
];
